...
\begin{figure}[H]
  \begin{tikzpicture}
    ...
    \addplot+ [boxplot={whisker range=\boxplotbignum}] table [y        index=0] {data5.txt};
      \addplot+ [boxplot={whisker range=\boxplotbignum}] table [y index=0] {data1.txt};
      \addplot+ [boxplot={whisker range=\boxplotbignum}] table [y index=0] {data2.txt};
      \addplot+ [boxplot={whisker range=\boxplotbignum}] table [y index=0] {data3.txt};
      \addplot+ [boxplot={whisker range=\boxplotbignum}] table [y index=0] {data4.txt};
    \end{axis}
  \end{tikzpicture}
...
\begin{figure}[H]
  \begin{tikzpicture}
    \begin{axis}[width=\linewidth, ytick={1, 2, 3}, yticklabels={TM, SSD, NSC}]
    \addplot+ [boxplot={whisker range=\boxplotbignum}] table [y        index=0] {data6.txt};
      \addplot+ [boxplot={whisker range=\boxplotbignum}] table [y index=0] {data7.txt};
      \addplot+ [boxplot={whisker range=\boxplotbignum}] table [y index=0] {data8.txt};
    \end{axis}
  \end{tikzpicture}
